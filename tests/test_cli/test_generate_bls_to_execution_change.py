...
from .helpers import clean_btec_folder, prepare_testing_folder, verify_file_permission
...
def test_existing_mnemonic_bls_withdrawal() -> None:
    ...
    # Check files
    bls_to_execution_changes_folder_path = os.path.join(
    ...
    verify_file_permission(
        os, folder_path=bls_to_execution_changes_folder_path, files=btec_files
    )
...
def test_existing_mnemonic_bls_withdrawal_multiple() -> None:
    ...
    arguments = [
        ...
        "sister protect peanut hill ready work profit fit wish want small inflict flip member tail between sick setup bright duck morning sell paper worry",  # noqa: E501
        "--bls_withdrawal_credentials_list",
        "0x00bd0b5a34de5fb17df08410b5e615dda87caf4fb72d0aac91ce5e52fc6aa8de, 0x00a75d83f169fa6923f3dd78386d9608fab710d8f7fcf71ba9985893675d5382",  # noqa: E501
        "--validator_start_index",
        "0",
        "--validator_indices",
        "1,2",

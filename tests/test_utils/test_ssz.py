...
@pytest.mark.parametrize(
    ...
    [
        (
            b"\x12" * 4,
            True,
            b"\x03\x00\x00\x00\rf`\x8a\xf5W\xf4\xfa\xdb\xfc\xe2H\xac7\xf6\xe7c\x9c\xe3q\x10\x0cC\xd1Z\xad\x05\xcb",
        ),  # noqa: E501
        (b"\x12" * 5, False, None),
        (b"\x12" * 3, False, None),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        (
            b"\x12" * 4,
            True,
            b"\rf`\x8a\xf5W\xf4\xfa\xdb\xfc\xe2H\xac7\xf6\xe7c\x9c\xe3q\x10\x0cC\xd1Z\xad\x05\xcb\x08\xac\x1d\xc2",
        ),  # noqa: E501
        (b"\x12" * 5, False, None),
        (b"\x12" * 3, False, None),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        (
            b"\x12" * 32,
            True,
            b"g\xa33\x0f\xf8{\xdbF\xbb{\x80\xcazd\x1e9\x8dj\xc4\xe8zhVR|\xac\xc8)\xfba\x89o",
        ),  # noqa: E501
        (b"\x12" * 31, False, None),
        (b"\x12" * 33, False, None),
    ],

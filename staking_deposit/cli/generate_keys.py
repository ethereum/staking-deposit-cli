    ...
    decorators = [
        ...
        jit_option(
            callback=captive_prompt_callback(
                ...
                lambda: load_text(
                    ["keystore_password", "confirm"],
                    func="generate_keys_arguments_decorator",
                ),
                lambda: load_text(
                    ["keystore_password", "mismatch"],
                    func="generate_keys_arguments_decorator",
                ),
                True,
            ),
        ...
        jit_option(
            callback=captive_prompt_callback(
                ...
                lambda: load_text(
                    ["arg_execution_address", "prompt"],
                    func="generate_keys_arguments_decorator",
                ),
                lambda: load_text(
                    ["arg_execution_address", "confirm"],
                    func="generate_keys_arguments_decorator",
                ),
                lambda: load_text(
                    ["arg_execution_address", "mismatch"],
                    func="generate_keys_arguments_decorator",
                ),
            ),
            default=None,
            help=lambda: load_text(
                ["arg_execution_address", "help"],
                func="generate_keys_arguments_decorator",
            ),
...
def generate_keys(
    ...
    **kwargs: Any,
    ...
    if not credentials.verify_keystores(
        keystore_filefolders=keystore_filefolders, password=keystore_password
    ):

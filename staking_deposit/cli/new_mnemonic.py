...
from staking_deposit.utils.constants import MNEMONIC_LANG_OPTIONS, WORD_LISTS_PATH
...
@jit_option(
    callback=captive_prompt_callback(
        ...
        choice_prompt_func(
            lambda: load_text(["arg_mnemonic_language", "prompt"], func="new_mnemonic"),
            languages,
        ),
    ),
    default=lambda: load_text(
        ["arg_mnemonic_language", "default"], func="new_mnemonic"
    ),
